...
namespace LemonadeStandCompany
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Well {ownerName} since lemonade is our Flagship product. Everyone must have atleast one lemonade stand.");
            ...
            if (popstandsdesired)
            {
                int numberOfPopsicleStands = UserInteraction.GetUserIntegerNumber($"{ownerName} how many popsickle stands do you want?");
